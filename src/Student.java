...
public class Student {
   ...
   public String ValidateData(){
	   if (name.length() == 0) return "SORRY: name required.";
	   if (test1 > 100 || test1 < 0) return "SORRY: Test 1 must be 0<= Test1 <= 100";
	   if (test2 > 100 || test2 < 0) return "SORRY: Test 2 must be 0<= Test1 <= 100";
	   if (test3 > 100 || test3 < 0) return "SORRY: Test 3 must be 0<= Test1 <= 100";
	   else return null;
   }
}
